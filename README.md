...
<h1>Julian Rincón</h1>
<h3>CS & AI Student &nbsp;·&nbsp; Data Science &nbsp;·&nbsp; Machine Learning &nbsp;·&nbsp; Autonomous Agents</h3>
...
```python
julian = {
    "focus":    ["Data Science", "Machine Learning", "Autonomous Agents", "Local AI"],
    "building": ["Jarvis IronMan — fully local voice assistant with LLMs",
                 "SAVI — RL-based autonomous real estate valuation system"],
    "stack":    ["Python", "AWS", "PyTorch", "XGBoost", "Ollama", "Terraform"],
